...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.024,
        help="Size of one checkerboard square in meters (default: 0.024 for 24mm)",
    )
    parser.add_argument(
        "--output",
        default="calibration.yaml",
        help="Path to save the output YAML file (default: calibration.yaml)",
    )
...
def main():
    ...
    for fname in images:
        ...
        if ret:
            ...
            # Use WINDOW_NORMAL so large images don't go off-screen
    ...
    # --- NEW: Save to YAML ---
    print(f"\nSaving calibration data to {args.output}...")
